...
- 👉 [Complete documentation](https://docs.appseed.us/products/django-dashboards/material-dashboard) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/django-dashboards/material-dashboard#environment)
  - ✅ [Manage App users](https://docs.appseed.us/products/django-dashboards/material-dashboard#manage-app-users)
  - ✅ [Application Bootstrap Flow](https://docs.appseed.us/products/django-dashboards/blamaterialk-dashboard#application-bootstrap-flow)
  - ✅ [App Routing](https://docs.appseed.us/products/django-dashboards/material-dashboard#project-routing)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/django-dashboards/material-dashboard#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/django-dashboards/material-dashboard#set-up-the-mysql-database)
  - ✅ [Adding a new app](https://docs.appseed.us/products/django-dashboards/material-dashboard#adding-a-new-app)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/django-dashboards/material-dashboard#static-assets-for-production) 
  
<br />

> Built with [Material Dashboard Generator](https://appseed.us/generator/material-dashboard/)

- Timestamp: `2022-06-12 18:32`
- Build ID: `cc9ba085-8cd2-4122-be37-c0059eef735c`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cc9ba085-8cd2-4122-be37-c0059eef735c.git
$ cd cc9ba085-8cd2-4122-be37-c0059eef735c
```
